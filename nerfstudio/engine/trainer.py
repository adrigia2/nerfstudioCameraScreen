...
class Trainer:
    ...
    def _after_train(self) -> None:
        ...
        self._comunicate_training_end_viewer_state()
    ...
    def _comunicate_training_end_viewer_state(self) -> None:
        """Communicate training end to the viewer"""
        if self.viewer_state is None:
            print("Viewer not enabled. Exiting training.")
            return
        self.viewer_state.training_end()
